							...
							<div class="d-flex h-100">
								...
								>
									...
									<p class="mb-0 text-white-50">
										An Oversight of a Comprehensive
										reporting for administrations duties
									</p>
								</div>
							</div>
						</div>
						...
						<div class="bg-black text-center h-100 project">
							<div class="d-flex h-100">
								...
								>
									...
									<p class="mb-0 text-white-50">
										Raise issue, submit concerns, make
										suggestion, The feeback loop is what
										makes us attend to you better
									</p>
								</div>
							</div>
						</div>
...
<style lang="scss">
	...
	*::after {
	...
	.form-select.is-valid:not([multiple])[size="1"] {
		...
		background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'%3e%3cpath fill='none' stroke='%23343a40' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='m2 5 6 6 6-6'/%3e%3c/svg%3e"),
			url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2367c29c' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
