			...
			<header class="masthead">
				...
				>
					<div class="d-flex justify-content-center">
						...
						N12K, you have the full experience of a one on one tutoring, your comfort  prioritise all your neccessary needs
							</h2>
				...
				<div class="container px-4 px-lg-5">
					<div class="row gx-4 gx-lg-5 justify-content-center">
						<div class="col-lg-8">
							...
							We believe in giving back to the community from which we have benefited from, that this the sole drive for this innovative platform, we tutor,
							 mentor, coach with practical lessons on how to grow wealth!.
							</p>
						</div>
					</div>
					<img
				...
				<div class="container px-4 px-lg-5">
						...
						<div class="col-xl-4 col-lg-5">
							<div class="featured-text text-center text-lg-left">
								...
								<p class="text-black-50 mb-0">
									Our Premium courses always got you covered
							...
							<div class="bg-black text-center h-100 project">
								<div class="d-flex h-100">
									...
									>
										...
										An Oversight of a Comprehensive reporting for administrations duties
					...
					<div class="row gx-0 justify-content-center">
						<div class="col-lg-6">
							<img
								class="img-fluid"
								src="../../../assets/img/ticketsraise.png"
								alt="..."
							/>
						</div>
						<div class="col-lg-6 order-lg-first">
							<div class="bg-black text-center h-100 project">
								<div class="d-flex h-100">
									...
									>
										<h4 class="text-white">Ticketing</h4>
										<p class="mb-0 text-white-50">
											Raise issue, submit concerns, make suggestion, The feeback loop is what makes us attend to you better
										</p>
									</div>
								</div>
							</div>
