...
export default function useAppCustomizer() {
   ...
   const contentWidthOptions = [ { text: 'Full  Width', value: 'full' }, { text: 'Boxed', value: 'boxed' } ];
   ...
   // Router Transition
   const layoutTypeOptions = [ { text: 'Vertical', value: 'vertical' }, { text: 'Horizontal', value: 'horizontal' } ];
